        ...
        moduleSteerRoutine = // I know SignalLogger is CTRE specific but I think this works regardless
            ...
            new SysIdRoutine(
                ...
                new SysIdRoutine.Mechanism(
                    (Measure<Voltage> volts) -> modules[0].runSteerCharacterization(volts.in(Units.Volts)),
                    null,
                    this));
        driveRoutine =
            new SysIdRoutine(
                new SysIdRoutine.Config(
                    ...
                    (state) -> SignalLogger.writeString("state", state.toString())),
                new SysIdRoutine.Mechanism(
                    (Measure<Voltage> volts) -> runDriveCharacterizationVolts(volts.in(Units.Volts)),
                    null,
                    this));
    }
    ...
    */
    ...
    public double[] getWheelRadiusCharacterizationPosition() {
        return Arrays.stream(modules)
            .mapToDouble((module) -> module.getPosition().distanceMeters / DriveConstants.Module.WHEEL_RADIUS)
            .toArray();
    }
